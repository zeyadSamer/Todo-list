...
var addUser = function (user) { return __awaiter(void 0, void 0, void 0, function () {
    var users, result, token, userData;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                users = new users_model_1.Users();
                return [4 /*yield*/, users.add(user)];
            case 1:
                result = _a.sent();
                if (result === null) {
...
var getUser = function (user) { return __awaiter(void 0, void 0, void 0, function () {
    var users, result, tokenSecret, token, userData;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                users = new users_model_1.Users();
                return [4 /*yield*/, users.show(user)];
            case 1:
                result = _a.sent();
                if (result === null) {
                    return [2 /*return*/, null];
                ...
                token = jsonwebtoken_1["default"].sign(result, tokenSecret);
                userData = {
                    id: result.id,
                    email: result.email,
                    token: token
